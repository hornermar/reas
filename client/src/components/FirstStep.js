...
const FirstStep = (props) => {
  ...
  return (
    <>
      <Typography className={classes.regionSelect} variant="h5" gutterBottom>
        Údaje o nemovitosti
      </Typography>
      ...
      <Typography className={classes.regionMap} variant="h6" gutterBottom>
        Neprve zvolte kraj, okres a poté typ nemovitosti
      </Typography>
      <Container className={classes.regionMap}>
        <svg style={{ marginTop: '20px' }} width="612.45972" height="350.61844">
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Jihočeský kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            ></path>
            <text className="region_text" id="Jihočeský kraj" x="170" y="280">
              Jihočeský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Jihomoravský kraj'
                ? 'region_active'
                : 'region'
            }
          >
            <path
              id="Jihomoravský kraj"
            ...
            />
            <text className="region_text" x="365" y="300">
              Jihomoravský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Karlovarský kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            />
            <text className="region_text" id="Karlovarský kraj" x="30" y="130">
              Karlovarský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Královéhradecký kraj'
                ? 'region_active'
                : 'region'
            }
          >
            <path
              id="Královéhradecký kraj"
          ...
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Liberecký kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            />
            <text className="region_text" id="Liberecký kraj" x="230" y="55">
              Liberecký
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Moravskoslezský kraj'
                ? 'region_active'
                : 'region'
            }
          >
            <path
              id="Moravskoslezský kraj"
          ...
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Olomoucký kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            />
            <text className="region_text" id="Olomoucký kraj" x="440" y="210">
              Olomoucký
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Pardubický kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            />
            <text className="region_text" id="Pardubický kraj" x="340" y="170">
              Pardubický
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Zlínský kraj' ? 'region_active' : 'region'
            }
          >
            <path
              id="Zlínský kraj"
            ...
            />
            <text className="region_text" id="Zlínský kraj" x="490" y="270">
              Zlínský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Plzeňský kraj' ? 'region_active' : 'region'
            }
          >
            <path
              id="Plzeňský kraj"
            ...
            />
            <text className="region_text" id="Plzeňský kraj" x="75" y="210">
              Plzeňský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Hlavní město Praha'
                ? 'region_active'
                : 'region'
            }
          >
            <path
              id="Hlavní město Praha"
          ...
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Středočeský kraj'
                ? 'region_active'
                : 'region'
            }
          >
            ...
            />
            <text className="region_text" id="Středočeský kraj" x="190" y="180">
              Středočeský
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Ústecký kraj' ? 'region_active' : 'region'
            }
          >
            <path
              id="Ústecký kraj"
            ...
            />
            <text className="region_text" id="Ústecký kraj" x="130" y="85">
              Ústecký
            </text>
          </g>
          <g
            onClick={handleClick}
            className={
              props.data.region === 'Kraj Vysočina' ? 'region_active' : 'region'
            }
          >
            <path
              id="Kraj Vysočina"
            ...
            />
            <text className="region_text" id="Kraj Vysočina" x="300" y="230">
              Vysočina
            </text>
          </g>
        </svg>
      ...
      <FormControl component="fieldset">
        <FormLabel component="legend">Typ nemovitosti</FormLabel>
        <RadioGroup
          row
          aria-label="estate-type"
          name="estate-type"
