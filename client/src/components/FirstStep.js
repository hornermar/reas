...
const FirstStep = (props) => {
  ...
  return (
    <>
      ...
      <svg width="612.45972" height="350.61844">
        <path
          id="Jihočeský kraj"
          className={
            props.data.region === 'Jihočeský kraj' ? 'region_active' : 'region'
          }
          onClick={handleClick}
        ...
        <path
          ...
          onClick={handleClick}
          className={
            props.data.region === 'Liberecký kraj' ? 'region_active' : 'region'
          }
        ...
        <path
          ...
          onClick={handleClick}
          className={
            props.data.region === 'Olomoucký kraj' ? 'region_active' : 'region'
          }
        ...
        <path
          ...
          onClick={handleClick}
          className={
            props.data.region === 'Pardubický kraj' ? 'region_active' : 'region'
          }
